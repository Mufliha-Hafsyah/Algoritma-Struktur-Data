...
public class MahasiswaDemo17 {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Menghitung Banyak Tugas yang Dikumpulkan");
            ...
            switch (pilih) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Mahasiswa17 bottom = stack.bottom();
                    if (bottom != null) {
                        System.out.println("Tugas pertama dikumpulkan oleh " + bottom.nama);
                    }
                    break;
                case 6 :
